<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Видео',
    'longtitle' => 'Видео про септик кристалл ',
    'description' => '',
    'alias' => 'video',
    'link_attributes' => '',
    'published' => 1,
    ...
    array (
      0 => 'seotitle',
      1 => 'Септик Кристалл для дачи и дома с установкой — видео обзор, инструкция, принцип работы',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Видео обзор, инструкция, принцип работы септика кристалл для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл, видео, инструкция, принцип работы',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Септик Кристалл для дачи и дома с установкой — видео обзор, инструкция, принцип работы</title>
<meta name="keywords" content="септик кристалл, видео, инструкция, принцип работы"/>
<meta name="description" content="Видео обзор, инструкция, принцип работы септика кристалл для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44."/>
...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/video/" />
<meta property="og:title" content="Септик Кристалл для дачи и дома с установкой — видео обзор, инструкция, принцип работы" /> 
<meta property="og:description" content="Видео обзор, инструкция, принцип работы септика кристалл для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44." />
...
<div class="vpl-wrapper js-vpl-wrapper main-page">
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`29` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section vide-list-page">
		<h1>[[!*longtitle:isnot=``:theen=`Видео про септик кристалл `:else=`Видео`]]</h1>
		<div class="video_tab_block">
			<div class="tab_name">
				<div target="t1">Принцип работы септика</div>
<div target="t2">Документация</div>
<div target="t3">Монтаж септика кристалл 5</div>
<div target="t4">Септик Кристалл на выставке Загородный Дом Весна 2019, г.</div>
<div target="t5">Как мы производим Септик Кристалл</div>
			</div>
			<div class="tab_data text-type-1">
				<div class="tab t1">
	[[!youtubetype1? &input=`sgdw7iFn-YM` &proportions=`1.7`]]
	<div class="content"><h2>Септик Кристалл 5 – принцип работы септика</h2>
...
<div class="tab t2">
	[[!youtubetype1? &input=`` &proportions=``]]
	<div class="content"></div>
</div>
<div class="tab t3">
	[[!youtubetype1? &input=`DZEslVwC7fQ` &proportions=`1.7`]]
	<div class="content"><p>Позвони нам и получи подробную инструкцию в печатном виде и узнай как установить Септик Кристалл самому: 8(495)104-42-44</p></div>
</div>
<div class="tab t4">
	[[!youtubetype1? &input=`7LJCPiHlEtk` &proportions=`1.6`]]
	<div class="content"><p><span>Самый популярный вопрос от посетителей выставки: Чем ваш Септик Кристалл отличается от известной модели со шлангами в конструкции? <br /><br />Наш ответ: <br /><br />- Надежней и проще конструкция <br />- Больше гарантия - Больше срок службы корпуса <br />- Не боится слива туалетной бумаги <br />- При переполнении вода не попадает в компрессорный отсек <br />- При прочистке не нужно промывать трубочки и шланги (их нет вовсе) <br />- Обслуживание не чаще одного раза в год и без специальных инженеров (просто откачка осадка насосом или машиной откачки) <br />- Дешевле на 20% <br /><br />Звоните и получите более подробную информацию: 8(495)104-42-44</span></p></div>
</div>
<div class="tab t5">
	[[!youtubetype1? &input=`9nhHmbi4xLk` &proportions=`1.7`]]
	<div class="content"><p><span>"Кристалл-Септик" - это производство современных систем очистки сточных вод для загородных домов. Мы разработали надежный и экономичный вариант загородной канализации, Септик Кристалл. Мы сами производим материал из которого сделан Септик Кристалл и поэтому можем гарантировать самую выгодную цену на рынке. </span></p>
<p><span>Главными преимуществами нашего Септика Кристалл являются: </span></p>
<p><span>1) Низкая цена (Септик Кристалл на 5 человек - 76000 руб.) </span></p>
<p><span>2) Корпус с самым высоким сроком службы (более 100 лет) </span></p>
<p><span>3) Большая гарантия (10 лет) </span></p>
<p><span>4) Простая и понятная конструкция (все элементы взаимозаменяемы) </span></p>
<p><span>5) Полная устойчивость к засору (можно сливать туалетную бумагу и стоки после измельчителя) </span></p>
<p><span>6) Очень простое сервисное обслуживание (осадок скапливается в течении года и удаляется насосом или обычной деревенской машиной откачки) </span></p>
<p><span>7) Если уровень воды поднимется, то вода не сможет попасть в сухой блок с электроникой (полная защита от затопления) </span></p>
<p><span>8) Все элементы конструкции выполнены из материалов устойчивых к коррозии. </span></p>
<p><span>Наш септик прост в установке. Если вы готовы установить Септик Кристалл своими руками, то мы вышлем вам сам септик и подробную инструкцию по установке, сохранив гарантию. </span></p>
<p><span>Звоните и узнайте как сэкономить на автономной канализации на вашем участке: 8(495)104-42-44</span></p></div>
</div>
			</div>
		</div>
	</section>
	<section class="vpl-section vpl-section-14 " >
	<div class="container">
		<div class="row">
	...
	<div id="garantii">
	<section class="vpl-section vpl-section-16 js-lazy" data-src="uploads/initial/38-autumn.jpg">
		<div class="container">
			<div class="row">
				<h2 class="text-center">гарантии</h2>
				<div class="vpl-garantii-list">
					<div class="clearfix">
						[[!getImageList? 
							&tvname=`gr_list`
							&docid=`20`
				...
				<div class="col-xs-15 text-center"> <a href="" class="btn btn-primary js-modal-open [#20.gr_button_event]]" data-modal="callback-ask">Остались вопросы? - Звоните нам!</a> <img class="vpl-section-10-img-1" data-src="uploads/initial/arrow-down-green.svg" width="10" height="102"> </div>
			</div>
		</div>
	</section>
</div>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[pdoResources?
					...
					&outerClass=`0`
					&resources=`0`
					&tpl=`@INLINE <div target="t[[+idx]]">[[+pagetitle]]</div>`
					&sortby=`menuindex`
					&sortdir=`ASC`
				]]' => '<div target="t1">Принцип работы септика</div>
<div target="t2">Документация</div>
...
<div target="t5">Как мы производим Септик Кристалл</div>',
    '[[pdoResources?
					...
					&outerClass=`0`
					&resources=`0`
					&tpl=`video_tab_block_li`
					&sortby=`menuindex`
					&includeContent=`1`
					&includeTVs=`tv_youtube,tv_proportions`
					&sortdir=`ASC`
				]]' => '<div class="tab t1">
	[[!youtubetype1? &input=`sgdw7iFn-YM` &proportions=`1.7`]]
	<div class="content"><h2>Септик Кристалл 5 – принцип работы септика</h2>
...
<p><span>Звоните и узнайте как сэкономить на автономной канализации на вашем участке: 8(495)104-42-44</span></p></div>
    ...
    '[[pdoResources?
	&parents=`0` &outerClass=`0` &resources=`0` &tpl=`clients_li` 
	&includeTVs=`cl_caption,cl_background,cl_list,cl_type_block,` &sortby=`menuindex` &sortdir=`ASC` 
	&where=`{"template:=":8}`
]]' => '<section class="vpl-section vpl-section-14 [[+tv.cl_background:is=``:else=`js-lazy`]]" [[+tv.cl_background:is=``:else=`data-src="[[+tv.cl_background]]"`]]>
	<div class="container">
		<div class="row">
			<h2 class="text-center">НАШИ ПАРТНЕРЫ</h2>
			<div class="clearfix">
    ...
    '[[$block_clients]]' => '<section class="vpl-section vpl-section-14 [[+tv.cl_background:is=``:else=`js-lazy`]]" [[+tv.cl_background:is=``:else=`data-src="[[+tv.cl_background]]"`]]>
	<div class="container">
		<div class="row">
			<h2 class="text-center">НАШИ ПАРТНЕРЫ</h2>
			<div class="clearfix">
    ...
    '[[$block_garantii]]' => '<div id="garantii">
	<section class="vpl-section vpl-section-16 js-lazy" data-src="uploads/initial/38-autumn.jpg">
		<div class="container">
			<div class="row">
				<h2 class="text-center">гарантии</h2>
	...
	&where=`{"template:=":8}`
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'block_garantii',
          'description' => 'Блок гарантии',
          'editor_type' => 0,
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div id="garantii">
	<section class="vpl-section vpl-section-16 js-lazy" data-src="uploads/initial/38-autumn.jpg">
		<div class="container">
			<div class="row">
				<h2 class="text-center">[[#20.gr_caption]]</h2>
				<div class="vpl-garantii-list">
					<div class="clearfix">
						[[!getImageList? 
							&tvname=`gr_list`
				...
				<div class="col-xs-15 text-center"> <a href="" class="btn btn-primary js-modal-open [#20.gr_button_event]]" data-modal="callback-ask">[[#20.gr_button]]</a> <img class="vpl-section-10-img-1" data-src="uploads/initial/arrow-down-green.svg" width="10" height="102"> </div>
			</div>
		</div>
	</section>
</div>',
...
return $output;',
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => 'if(trim($input)!=\'\') return \'<div class="video"><iframe pr="\'.$proportions.\'" src="https://www.youtube.com/embed/\'.$input.\'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>\';',
          'locked' => false,
          'properties' => 
          array (
          ),
          ...
          'static' => false,
          'static_file' => '',
          'content' => 'if(trim($input)!=\'\') return \'<div class="video"><iframe pr="\'.$proportions.\'" src="https://www.youtube.com/embed/\'.$input.\'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>\';',
        ),
        'policies' => 
        array (
          'web' => 
