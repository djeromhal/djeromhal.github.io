<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h2 class="text-center">Отзывы</h2>',
    'richtext' => 1,
    'template' => 17,
    'menuindex' => 5,
    'searchable' => 1,
    ...
    array (
      0 => 'seotitle',
      1 => 'Септик Кристалл — отзывы владельцев: станция биологической очистки',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Автономная канализация Септик Кристалл — отзывы владельцев | Станция биологической очистки | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл, отзывы владельцев, станция биологической очистки, автономная канализация',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Септик Кристалл — отзывы владельцев: станция биологической очистки</title>
<meta name="keywords" content="септик кристалл, отзывы владельцев, станция биологической очистки, автономная канализация"/>
<meta name="description" content="Автономная канализация Септик Кристалл — отзывы владельцев | Станция биологической очистки | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44."/>
...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/otzyivyi/" />
<meta property="og:title" content="Септик Кристалл — отзывы владельцев: станция биологической очистки" /> 
<meta property="og:description" content="Автономная канализация Септик Кристалл — отзывы владельцев | Станция биологической очистки | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44." />
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`28` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section vpl-section-1 vpl-slider-container js-slider-container">
	<div class="vpl-slider js-slider">
		[[!slider1]]
	</div>
</section>
	...
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				<div class="review-block text"><h2 class="text-center">Отзывы</h2></div>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[$block_slider]]' => '<section class="vpl-section vpl-section-1 vpl-slider-container js-slider-container">
	<div class="vpl-slider js-slider">
		[[!slider1]]
	</div>
</section>',
    '[[$block_review]]' => '<div id="nam-doverjajut">
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				<div class="review-block text"><h2 class="text-center">Отзывы</h2></div>
...
<div id="menu" class="vpl-navbar">
	<ul class="list-inline vpl-menu mobile">
      ...
      array (
        ...
        array (
          ...
          'category' => 13,
          'cache_type' => 0,
          'snippet' => '<section class="vpl-section vpl-section-1 vpl-slider-container js-slider-container">
	<div class="vpl-slider js-slider">
		[[!slider1]]
	</div>
</section>',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="vpl-section vpl-section-1 vpl-slider-container js-slider-container">
	<div class="vpl-slider js-slider">
		[[!slider1]]
	</div>
</section>',
	...
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				<div class="review-block text">[[*content]]</div>
				<div class="clearfix vpl-review-list">
					<div class="col-xs-5 col-xs-offset-1">
						[[!getImageList?
							&docid=`11`
	...
	<div class="content"></div>
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div class="pp-body-mm"></div>
<div class="pp-body"></div>
<div class="pp ware">
	<table class="arcticmodal-container_i">
		<tbody>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="pp-body-mm"></div>
<div class="pp-body"></div>
<div class="pp ware">
	<table class="arcticmodal-container_i">
		<tbody>
...
return $output;',
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '$resource=$modx->resource;
...
foreach($data as $n=>$v){
	if($v[\'active\']==1){
		...
		if($v[\'type\']==3)echo $modx->getChunk(\'slider1_li_type3\',$v);
          ...
          'static' => false,
          'static_file' => '',
          'content' => '$resource=$modx->resource;
$data=json_decode($resource->getTVValue(\'slider1\'),true);
foreach($data as $n=>$v){
	if($v[\'active\']==1){
		if($v[\'type\']==1)echo $modx->getChunk(\'slider1_li_type1\',$v);
...
return (int)(strtolower($input) == $device);',
	...
	"fields": [{
		...
		"caption": "Тип слайда",
		"inputTVtype": "listbox",
		"inputOptionValues": "Тип 1==1||Тип 2==2||Тип 3==3"
	},{
		"field": "fone",
		"caption": "Картина",
		"inputTVtype": "image"
		...
		"field": "icon_text",
		"caption": "Подпись к иконке (Тип 1)"
	},{
		"field": "caption",
		"caption": "Большой заголовок"
	},{
		"field": "block1_text",
		"caption": "Подпись блока контактов"
	},{
		"field": "block1_phone",
		"caption": "Телефон для человека (в формате 9 999 999-99-99 или любом по желанию)"
	},{
		"field": "block1_phone_machine",
		"caption": "Телефон для машины (в формате +79999999999)"
	},{
		"field": "block1_email",
		"caption": "Email"
	},{
		"field": "text",
		"caption": "Текст на темном фоне",
		"inputTVtype": "textarea"
	},{
		"field": "button_name",
		"caption": "Подпись к кнопке (тип 2)"
	},{
		"field": "button_even",
		"caption": "Событие на кнопке (тип 2)"
	},{
		"field": "active",
		"caption": "Активный",
		"inputTVtype": "listbox",
	...
	"header": "Подпись к иконке",
	"sortable": "true",
	"dataIndex": "icon_text"
	},{
	"header": "Большой заголовок",
	"sortable": "true",
	"dataIndex": "caption"
	},{
	"header": "Подпись блока контактов",
	"sortable": "true",
	"dataIndex": "block1_text"
	},{
	"header": "Телефон",
	"sortable": "true",
	"dataIndex": "block1_phone"
	},{
	"header": "Email",
	"sortable": "true",
	"dataIndex": "block1_email"
	},{
	"header": "Текст на темном фоне",
	"sortable": "true",
	"dataIndex": "text"
	},{
	"header": "Подпись к кнопке",
	"sortable": "true",
	"dataIndex": "button_name"
	},{
	"header": "Событие на кнопке",
	"sortable": "true",
	"dataIndex": "button_even"
	},{
	"header": "Активный",
	"sortable": "false",
	"dataIndex": "active",
