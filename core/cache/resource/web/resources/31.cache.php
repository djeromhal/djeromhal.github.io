...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/contacts/" />
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`31` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section text_section contact_page">
		<div class="container">
			<h1>Контакты — "Септик Кристалл"</h1>
			<div class="row cont1">
				<div class="col-md-4">
					<div class="img">
						<img src="uploads/contact/phone-call.svg" alt="">
						<p>ЗВОНИТЕ</p>
					</div>
					<a href="tel:84951044244" class="name">8 495 104-42-44</a>
				</div>
				<div class="col-md-4">
					<div class="img">
						<img src="uploads/contact/placeholder.svg" alt="">
						<p>ПРИХОДИТЕ</p>
					</div>
					<div class="name">ООО "Кристалл-Септик" </div>
					<p>141035, Россия, ГП Мытищи, <br> пос. Мебельной фабрики <br> ул. Шоссейная стр. 1/1 </p>
					<div class="name">Производство</div>
					<p>Тверская область. г. Конаково, Восточно-Промышленный район д. 16</p>
				</div>
				<div class="col-md-4">
					<div class="img">
						<img src="uploads/contact/mailer-ico.svg" alt="">
						<p>ПИШИТЕ</p>
					</div>
					<a href="email:kristall.septic@gmail.com" class="name">kristall.septic@gmail.com</a>
				</div>
			</div>
			<div class="row cont2">
				<div class="col-md-6">
					<div class="item">
						<div class="icon"><img src="uploads/contact/clock.svg" alt=""></div>
						<div class="name">ВРЕМЯ ПРИЕМА ЗАЯВОК ПО ТЕЛЕФОНУ:</div>
						<p>в будние дни с 10:00 до 19:00 по Мск</p>
					</div>
					<div class="item">
						<div class="icon"><img src="uploads/contact/clock24.svg" alt=""></div>
						<div class="name">ВРЕМЯ ПРИЕМА ЗАЯВОК ЧЕРЕЗ САЙТ</div>
						<p>круглосуточно</p>
					</div>
					<div class="item">
						<div class="icon"><img src="uploads/contact/truck.svg" alt=""></div>
				...
				<div class="col-md-6">
					<div class="item">
						<div class="icon"><img src="uploads/contact/grafik_ico.png" alt=""></div>
						<div class="name">ГРАФИК РАБОТЫ:</div>
						<p>понедельник – пятница, с 10:00 до 19:00, суббота и воскресенье – выходной</p>
					</div>
					<div class="item">
						<div class="icon"><img src="uploads/contact/phone-call-grey.svg" alt=""></div>
						<div class="name">ТЕЛЕФОН СЛУЖБЫ ПОДДЕРЖКИ</div>
						<p>8 495 104-42-44</p>
					</div>
					<div class="item">
						<div class="icon"><img src="uploads/contact/oplata.svg" alt=""></div>
						<div class="name">ОПЛАТА:</div>
						<p>наличными при получении и онлайн</p>
						<p><img src="uploads/contact/card-viza.png" alt="card"></p>
	...
	<form>
		...
		<div class="field check checkbox">
			...
			<div class="content"><iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3A71a0894de9c65e4d07863cee043811b702b5cbd051e7a8f85d1d0bd37b52b117&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe></div>
		</div>
	</section>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[$map-me]]' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3A71a0894de9c65e4d07863cee043811b702b5cbd051e7a8f85d1d0bd37b52b117&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
    '[[pdoResources?
	...
	<form>
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3A71a0894de9c65e4d07863cee043811b702b5cbd051e7a8f85d1d0bd37b52b117&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
          'locked' => false,
          'properties' => 
          array (
          ),
          'static' => false,
          'static_file' => '',
          'content' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3A71a0894de9c65e4d07863cee043811b702b5cbd051e7a8f85d1d0bd37b52b117&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
        ),
        'policies' => 
        array (
          'web' => 
