<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'СЕПТИК КРИСТАЛЛ 8',
    'longtitle' => '<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8',
    'description' => 'Септик Кристалл 8 - модель категории "Комфорт".  Обслуживает коттедж или летний дом для семьи из 6-8 человек. Расчет на 3 туалета, 3 раковины, 2 душа, ванну, посудомоечную и стиральную машину. Глубина подключения - 70 см.  ',
    'alias' => 'septik-kristall-8',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'introtext' => '',
    'content' => '<h2> </h2>
<h2>Септик Кристалл 8 – станция глубокой биологической очистки</h2>
<p>Грамотное решением как для летнего дома, так и для всесезонного коттеджа. Подходит для любого участка и любого типа грунта. За работу станции отвечают компрессор Secoh (Япония) и насос Pedrollo (Италия) - моторы с длительным сроком службы и пониженным энергопотреблением.</p>
<h2>Преимущества автономной станции Кристалл</h2>
<p>Септик Кристалл 8 - наиболее популярная модель уровня "Комфорт". Заслужила внимание клиентов за простую и надежную конструкцию. Локальное очистное сооружение Кристалл:</p>
<ul>
<li>имеет прочный корпус с максимальными антикоррозийными свойствами;</li>
<li>обладает высоким уровнем очистки круглый год</li>
<li>может быть установлено на участке с любым типом грунта и уровнем грунтовых вод;</li>
<li>препятствует вымыванию микрофлоры из рабочей зоны;</li>
<li>не источает неприятного запаха;</li>
<li>сохраняет тишину;</li>
<li>обслуживается без участия специального инженера;</li>
<li>устойчиво к засорению и легко перерабатывает туалетную бумагу;</li>
<li>имеет защищенный от влаги короб для размещения всей электроники;</li>
<li>рассчитано как на регулярную, так и на периодическую эксплуатацию;</li>
<li>продолжает функционировать как обычный септик, даже при отсутствии электричества;</li>
<li>исправно служит более 10 лет без существенных трат на сервисное обслуживание;</li>
</ul>',
    'richtext' => 1,
    'template' => 12,
    'menuindex' => 2,
    ...
    'cacheable' => 1,
    'createdby' => 9,
    'createdon' => 1546197115,
    'editedby' => 4,
    'editedon' => 1550928149,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1546197060,
    'publishedby' => 9,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'w_princip_text',
      1 => '<h2>Септик Кристалл 8 – принцип работы</h2>
<p>Метод очистки аэрационной станции "Септик Кристалл" прост и универсален для либого цикла использования. В основе очистки протекают естественные природные процессы, действие которых усиливается с помощью подачи воздуха.</p>
<p>Другими словами метод очистки основан на активном биологическом разложении под воздействием микроорганизмов. Процессу разложения способствуют непрерывная подача воздуха от компрессора и рециркуляция стоков через блок биореактора.</p>
<h2>Конструкция способствует очистке</h2>
<p>Сетчитая структура биозагрузки создает благоприятные условия для   поддержания жизнидеятельности микроорганизмов, даже во время длительного отсутствия новых стоков.</p>
<p>Диагональные стенки центральной камеры и корпуса сгущают взвешенные в воде частицы, и ускоряют процесс осаждения. Воды камеры биореактора и внешней камеры отстойника сообщаются через дно септика. В результате, на поверхности внешней камеры образуется осветленный сток, который перетекает в третью камеру. </p>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
    ...
    array (
      0 => 'w_montag_text',
      1 => '<h2>Септик Кристалл 8 – монтажная схема</h2>
<p>Недорогое и эффективное локальное очистное сооружение для обслуживания загородного дома и дачи, обеспечивающее полноценное (до 98%) очищение. Устройство пользуется большим спросом, его можно недорого купить в Москве или заказать с доставкой в свой город.</p>
<h2>Преимущества автономной станции кристалл</h2>
<p>Станция Кристалл 5 на данный момент очень востребована, что можно легко объяснить ее многочисленными эксплуатационными достоинствами. Локальное очистное сооружение Кристалл:</p>
<ul>
<li>имеет прочный цельный корпус без швов и с хорошо запаянными стенками;</li>
<li>обладает высоким объемом залпового сброса (500 л) и большой производительностью (спуск целой ванны никак не отразится на рабочих показателях механизма);</li>
<li>может быть установлено на участке с любым типом грунта (его движения и нагрузки не страшны);</li>
<li>не вымывает активный ил и полезную микрофлору;</li>
<li>не источает неприятного запаха;</li>
<li>не издает надоедающего шума;</li>
<li>не подвержено засорению;</li>
<li>рассчитано как на регулярную, так и на периодическую эксплуатацию;</li>
<li>поддерживает работоспособность круглый год;</li>
<li>продолжает функционировать даже при отсутствии электричества;</li>
<li>исправно служит в течение 10 и более лет.</li>
</ul>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
    'w_specifications_text' => 
    array (
      0 => 'w_specifications_text',
      1 => '<h2>Септик Кристалл 8 – характеристики</h2>
<p>Легкий, прочный и компактный корпус из стеклопалстика и постоянная готовность чистить стоки с кухни, из ванной комнаты, туалета, от посудомоечной и стиральной машины.</p>
<h2>Производительность:</h2>
<p>Степень очистки - 98 %<br />Электропотребление компрессора - 60 Вт (постоянный режим работы)<br />Расчет на кол-во проживающих - до 8 человек<br />Сброс ванны до 400 л - 1 раз в течении 4 часов<br />Сброс туалетной бумаги - разрешен</p>
<h2>Габаритные размеры:</h2>
<p>Длина – 1 500 мм<br />Высота – 2 205 мм<br />Ширина - 1 500 мм<br />Диаметр входного отверстия – 110 мм<br />Диаметр выходного отверстия – 110 мм<br />Диаметр инспекционной трубы – 200 мм<br />Глубина подвода трубопровода - 700 мм</p>
<h2>Прочие характеристики:</h2>
<p>Материал – стеклопластик<br />Толщина корпуса - 5 мм<br />Вес – 120 кг<br />Срок службы корпуса - более 50 лет</p>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
    ...
    array (
      0 => 'w_sert_list',
      1 => '[{"MIGX_id":"1","photo":"certificate\\/5\\/1.jpg","name":"","text":"","active":"1"},{"MIGX_id":"2","photo":"certificate\\/5\\/2.jpg","name":"","text":"","active":"1"},{"MIGX_id":"3","photo":"certificate\\/5\\/3.jpg","name":"","text":"","active":"1"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'w_dostavka_text',
      1 => '<h2>Септик Кристалл 8 – доставка и оплата</h2>
<div class="name">
<h2 class="name">ДОСТАВКА:</h2>
<p>бесплатная в пределах МО, и бесплатная доставка до терминала любого города России</p>
</div>
<div class="name"> </div>
<h2 class="name">ОПЛАТА:</h2>
<p>наличными при получении и онлайн</p>
<p>Visa, Mastercard, Maestro, Мир, Сбербанк онлайн, Альфабанк</p>
<p>В безпроцентную рассрочку (Подробнее)</p>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
    ...
    'menu_main_mobile_show' => 
    array (
      0 => 'menu_main_mobile_show',
      1 => '0',
      2 => 'default',
      3 => NULL,
      4 => 'listbox',
    ),
    'menu_main_mobile_sort' => 
    array (
      0 => 'menu_main_mobile_sort',
      1 => '0',
      2 => 'default',
      3 => NULL,
      4 => 'number',
    ...
    array (
      0 => 'seotitle',
      1 => 'Септик Кристалл 8 — купить станцию биологической очистки Кристалл 8 в Москве: Автономная канализация для дома и дачи',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Септик Кристалл 8 (автономная канализация) от производителя в Москве. Купить станцию биологической очистки Кристалл 8 с установкой. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    'menu_footer_menuindex' => 
    array (
      0 => 'menu_footer_menuindex',
      1 => '13',
      2 => 'default',
      3 => NULL,
      4 => 'number',
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл 8, автономная канализация кристалл 8, станция биологической очистки кристалл 8',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Септик Кристалл 8 — купить станцию биологической очистки Кристалл 8 в Москве: Автономная канализация для дома и дачи</title>
<meta name="keywords" content="септик кристалл 8, автономная канализация кристалл 8, станция биологической очистки кристалл 8"/>
<meta name="description" content="Септик Кристалл 8 (автономная канализация) от производителя в Москве. Купить станцию биологической очистки Кристалл 8 с установкой. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44."/>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="yandex-verification" content="e1790a5ca20fdcc4" />
<meta name="google-site-verification" content="rPRS_97wuWWdagwu1dqNMR8-cHIfzZoycZtkXIWPxS4" />
<meta property="og:locale" content="ru_RU" />
<meta property="og:type" content="website" /> 
<meta property="og:locality" content="Москва"/>
<meta property="og:country-name" content="Россия"/>
<meta property="og:image" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/tpl/images/logo.svg"/>
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/septik-kristall-8/" />
<meta property="og:title" content="Септик Кристалл 8 — купить станцию биологической очистки Кристалл 8 в Москве: Автономная канализация для дома и дачи" /> 
<meta property="og:description" content="Септик Кристалл 8 (автономная канализация) от производителя в Москве. Купить станцию биологической очистки Кристалл 8 с установкой. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44." />
...
<!--[if lt IE 9]>
	...
	<script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
<![endif]-->
<link href="/tpl/css/core.css" type="text/css" rel="stylesheet" />
<link href="/tpl/css/popup.css" type="text/css" rel="stylesheet" />
<link href="/tpl/css/news.list.css" type="text/css" rel="stylesheet" />
<link href="/tpl/css/bootstrap.min.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/bootstrap-theme.min.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/slick.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/animate.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/jquery.arcticmodal.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/baguetteBox.min.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/style.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/style-responsive.min.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/lightbox.css" type="text/css" data-template-style="true" rel="stylesheet" />
<link href="/tpl/css/main-menu.css" type="text/css" data-template-style="true" rel="stylesheet" />
...
<script type="text/javascript">(window.BX||top.BX).message({\'LANGUAGE_ID\':\'ru\',\'FORMAT_DATE\':\'DD.MM.YYYY\',\'FORMAT_DATETIME\':\'DD.MM.YYYY HH:MI:SS\',\'COOKIE_PREFIX\':\'BITRIX_SM\',\'SERVER_TZ_OFFSET\':\'10800\',\'SITE_ID\':\'s1\',\'SITE_DIR\':\'/\',\'USER_ID\':\'\',\'SERVER_TIME\':\'1542102365\',\'USER_TZ_OFFSET\':\'0\',\'USER_TZ_AUTO\':\'Y\',\'bitrix_sessid\':\'8f3dc086596dc11b822e10e9bfbe136e\'});</script>
<script type="text/javascript" src="/tpl/js/core.js"></script>
<script type="text/javascript" src="/tpl/js/core_ajax.js"></script>
<script type="text/javascript" src="/tpl/js/core_window.js"></script>
<script type="text/javascript" src="/tpl/js/css_browser_selector.js"></script>
...
<script type="text/javascript" src="/tpl/js/jquery.viewportchecker.min.js"></script>
<script type="text/javascript" src="/tpl/js/jquery.arcticmodal.js"></script>
<script type="text/javascript" src="/tpl/js/baguetteBox.min.js"></script>
...
<script type="text/javascript" src="/tpl/js/jquery.lazy.min.js"></script>
<script type="text/javascript" src="/tpl/js/featherlight.min.js"></script>
<script type="text/javascript" src="/tpl/js/lightbox.js"></script>
<script type="text/javascript" src="/tpl/js/scripts.js"></script>
<script type="text/javascript" src="/tpl/js/jquery.lazyload.js"></script>
<script type="text/javascript" src="/tpl/js/jquery.bxslider.min.js"></script>
<script type="text/javascript">var _ba = _ba || []; _ba.push(["aid", "d5e5d8e9c8e3a8cecafac37337869ce0"]); _ba.push(["host", "kristall-landing"]); (function() {var ba = document.createElement("script"); ba.type = "text/javascript"; ba.async = true;ba.src = (document.location.protocol == "https:" ? "https://" : "http://") + "bitrix.info/ba.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(ba, s);})();</script>
...
<base href="https://xn----7sbqjdhfea6benejh.xn--p1ai/" />
...
<noscript><div><img src="https://mc.yandex.ru/watch/52275103" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-134048217-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag(\'js\', new Date());

  gtag(\'config\', \'UA-134048217-1\');
</script>
</head>
<body>
<div id="bx_panel"></div>
<div class="vpl-overlay js-vpl-overlay vpl-anim">
	<div class="loader2"></div>
</div>
<div class="vpl-wrapper js-vpl-wrapper">
	<div class="regionselection">
	<div class="container">
		<div class="row">
			<div class="close">x</div>
			<ul>
				<li><span>какой-то город</span></li>
				[[[pdoResources?
					&parents=`2`
					&tpl=`@INLINE <li><span>[[+tv.geo_name]][[+pagetitle]]</span></li>`
					&includeTVs=`geo_name`
					&limit=`20`
					&where=`{"template:=":10}`
...
<div class="line-top-logo">
	<div class="wrapper">
		<div class="logo">
			<a href="/"><img src="tpl/images/logo.svg" alt="Септик Кристалл — официальный сайт производителя"/></a>
		</div>
		<div class="slogan">Официальный сайт производителя Септик Кристалл в России</div>
	</div>
</div>
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			<div class="vpl-pull-menu" id="menu-pull"><i></i><i></i><i></i><i></i></div>
			<ul class="list-inline vpl-menu pc [[!If? &subject=`34` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
				<li class="vpl-menu-item item-1"><a href="/">Главная</a><ul class="submenu "><li class="vpl-menu-item item-7"><a href="my-predlagaem/">Мы Предлагаем</a></li><li class="vpl-menu-item item-8"><a href="kak-rabotaem/">Как работаем</a></li><li class="vpl-menu-item item-9"><a href="galereja/">Галерея</a></li><li class="vpl-menu-item item-10"><a href="pochemu-vybirajut-nas/">Почему выбирают нас</a></li><li class="vpl-menu-item item-11"><a href="nam-doverjajut/">Нам доверяют</a></li></ul></li><li class="vpl-menu-item item-27"><a href="catalog/">Каталог</a></li><li class="vpl-menu-item item-43"><a href="rasschitat-pod-klyuch/">Рассчитать под ключ</a></li><li class="vpl-menu-item item-30"><a href="dilers/">Где купить</a></li><li class="vpl-menu-item item-44"><a href="informacziya/">Информация</a><ul class="submenu "><li class="vpl-menu-item item-26"><a href="about/">О нас</a></li><li class="vpl-menu-item item-45"><a href="news/">Новости</a></li><li class="vpl-menu-item item-29"><a href="video/">Видео</a></li><li class="vpl-menu-item item-28"><a href="otzyivyi/">Отзывы</a></li><li class="vpl-menu-item item-47"><a href="stock/">Акции</a></li></ul></li><li class="vpl-menu-item item-31"><a href="contacts/">Контакты</a></li>
			</ul>
			<img src="/uploads/icon/logo_while.svg" alt="Кристалл Септик" class="mobile">
			<div class="region" style=""><div class="button" style="">Москва и область</div></div>
		</div>
	</div>
</nav>
<div id="menu" class="vpl-navbar">
	<ul class="list-inline vpl-menu mobile">
		<li class="vpl-menu-item item-1"><a href="/">Главная</a></li><li class="vpl-menu-item item-27"><a href="catalog/">Каталог</a></li><li class="vpl-menu-item item-43"><a href="rasschitat-pod-klyuch/">Рассчитать под ключ</a></li><li class="vpl-menu-item item-30"><a href="dilers/">Где купить</a></li><li class="vpl-menu-item item-31"><a href="contacts/">Контакты</a></li><li class="vpl-menu-item item-44"><a href="informacziya/">Информация</a><ul class="submenu "><li class="vpl-menu-item item-26"><a href="about/">О нас</a></li><li class="vpl-menu-item item-45"><a href="news/">Новости</a></li><li class="vpl-menu-item item-29"><a href="video/">Видео</a></li><li class="vpl-menu-item item-28"><a href="otzyivyi/">Отзывы</a></li><li class="vpl-menu-item item-47"><a href="stock/">Акции</a></li></ul></li>
	</ul>
</div>
	<section class="vpl-section text_section ware_page">
	...
	[[!pdoCrumbs?
		...
		<div class="container">
			<h1 class="ware_caption">[[!*longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8`:else=`СЕПТИК КРИСТАЛЛ 8`]]</h1>
			<div class="row">
				<div class="col-md-6">
					<div class="big">
						<ul>
							[[!ms2Gallery?
								...
								&tplRow=`@INLINE <li><a href="[[+url]]" title="[[+title]]" data-lightbox="vpl-gallery"><img src="[[+289x447]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/></a></li>`
								&tplEmpty=`0`
								&frontend_css=``
							]]
							[[!3d_model]]
					...
					<div class="small">
						<ul>
							...
							[[!ms2Gallery?
								&resource=`34`
								&tplOuter=`@INLINE [[+rows]]`
								&tplRow=`@INLINE <li class="s[[+idx]]" target="[[+idx]]" ><img src="[[+100x100]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/></li>`
								&tplEmpty=`0`
								&frontend_css=``
							]]
						</ul>
				...
				<div class="col-md-6 detail">
					...
					<div class="item">
						<div class="icon"><img src="/uploads/icon/sliv-24.svg" alt="объем сброса"></div>
						<div class="desc">
					...
					<div class="item">
						...
						<div class="desc">
							...
							<div class="value"><span>самотек</span></div>
						</div>
					</div>
					<div class="item">
					...
					<div class="price-block">
						<div class="price">99 750 <span>руб</span></div>
						<div class="old_price">
							<span class="name">цена без скидки </span>
							<span class="pr">105 000 руб</span>
						</div>
					</div>
					<div class="button-block">
						<div class="row">
							<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="34">Заказать</div></div>
							<div class="col-md-6"><div class="button t2 js-modal-open" data-modal="callback-free-meter">Вызвать инженера</div></div>
						</div>
						<div class="row">
							<div class="col-md-12"><div class="button orange" onclick="ShowModalKQuizType1()">Смета "под ключ"</div></div>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="ware_tab_block">
						<div class="tab_name">
							<div target="t1" class="active">Описание</div>
							<div target="t2">Принцип работы</div>
							<div target="t3">Монтажная схема</div>
							<div target="t4">Характеристики</div>
							<div target="t5">Доставка и оплата</div>
						</div>
						<div class="tab_data text-type-1">
							<div class="tab t1 active"><h2> </h2>
<h2>Септик Кристалл 8 – станция глубокой биологической очистки</h2>
<p>Грамотное решением как для летнего дома, так и для всесезонного коттеджа. Подходит для любого участка и любого типа грунта. За работу станции отвечают компрессор Secoh (Япония) и насос Pedrollo (Италия) - моторы с длительным сроком службы и пониженным энергопотреблением.</p>
<h2>Преимущества автономной станции Кристалл</h2>
<p>Септик Кристалл 8 - наиболее популярная модель уровня "Комфорт". Заслужила внимание клиентов за простую и надежную конструкцию. Локальное очистное сооружение Кристалл:</p>
...
<li>исправно служит более 10 лет без существенных трат на сервисное обслуживание;</li>
							...
							<div class="tab t2"><h2>Септик Кристалл 8 – принцип работы</h2>
<p>Метод очистки аэрационной станции "Септик Кристалл" прост и универсален для либого цикла использования. В основе очистки протекают естественные природные процессы, действие которых усиливается с помощью подачи воздуха.</p>
<p>Другими словами метод очистки основан на активном биологическом разложении под воздействием микроорганизмов. Процессу разложения способствуют непрерывная подача воздуха от компрессора и рециркуляция стоков через блок биореактора.</p>
<h2>Конструкция способствует очистке</h2>
<p>Сетчитая структура биозагрузки создает благоприятные условия для   поддержания жизнидеятельности микроорганизмов, даже во время длительного отсутствия новых стоков.</p>
<p>Диагональные стенки центральной камеры и корпуса сгущают взвешенные в воде частицы, и ускоряют процесс осаждения. Воды камеры биореактора и внешней камеры отстойника сообщаются через дно септика. В результате, на поверхности внешней камеры образуется осветленный сток, который перетекает в третью камеру. </p></div>
							<div class="tab t3"><h2>Септик Кристалл 8 – монтажная схема</h2>
<p>Недорогое и эффективное локальное очистное сооружение для обслуживания загородного дома и дачи, обеспечивающее полноценное (до 98%) очищение. Устройство пользуется большим спросом, его можно недорого купить в Москве или заказать с доставкой в свой город.</p>
<h2>Преимущества автономной станции кристалл</h2>
<p>Станция Кристалл 5 на данный момент очень востребована, что можно легко объяснить ее многочисленными эксплуатационными достоинствами. Локальное очистное сооружение Кристалл:</p>
<ul>
...
<li>исправно служит в течение 10 и более лет.</li>
							...
							<div class="tab t4"><h2>Септик Кристалл 8 – характеристики</h2>
<p>Легкий, прочный и компактный корпус из стеклопалстика и постоянная готовность чистить стоки с кухни, из ванной комнаты, туалета, от посудомоечной и стиральной машины.</p>
<h2>Производительность:</h2>
<p>Степень очистки - 98 %<br />Электропотребление компрессора - 60 Вт (постоянный режим работы)<br />Расчет на кол-во проживающих - до 8 человек<br />Сброс ванны до 400 л - 1 раз в течении 4 часов<br />Сброс туалетной бумаги - разрешен</p>
<h2>Габаритные размеры:</h2>
<p>Длина – 1 500 мм<br />Высота – 2 205 мм<br />Ширина - 1 500 мм<br />Диаметр входного отверстия – 110 мм<br />Диаметр выходного отверстия – 110 мм<br />Диаметр инспекционной трубы – 200 мм<br />Глубина подвода трубопровода - 700 мм</p>
<h2>Прочие характеристики:</h2>
<p>Материал – стеклопластик<br />Толщина корпуса - 5 мм<br />Вес – 120 кг<br />Срок службы корпуса - более 50 лет</p></div>
							<div class="tab t5"><h2>Септик Кристалл 8 – доставка и оплата</h2>
<div class="name">
<h2 class="name">ДОСТАВКА:</h2>
<p>бесплатная в пределах МО, и бесплатная доставка до терминала любого города России</p>
</div>
...
<p>наличными при получении и онлайн</p>
<p>Visa, Mastercard, Maestro, Мир, Сбербанк онлайн, Альфабанк</p>
<p>В безпроцентную рассрочку (Подробнее)</p></div>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="vpl-section vpl-section-certificate">
		<div class="container">
			<div class="caption">Сертификаты Кристалл:</div>
			<div class="row">
				[[!getImageList? 
					&tvname=`w_sert_list`
					&where=`{"active":"1"}`
	...
	<div id="nam-doverjajut">
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				<h2 class="text-center">нам доверяют</h2>
				<div class="clearfix vpl-review-list">
	...
	<div id="on-tv">
	<section class="vpl-section vpl-section-video">
	<div class="container">
		<div class="row">
			<h2 class="text-center">О заводе</h2>
			<div class="clearfix">
				<div class="responsive-embed widescreen">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/9nhHmbi4xLk"; frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</section>
</div>
	<section class="vpl-section vpl-section-similar">
		<div class="container">
			<div class="caption">похожие товары</div>
			<div class="row">
				<div class="col-md-4">
	<div class="item-ware">
		<a href="septik-kristall-5/" title="СЕПТИК КРИСТАЛЛ 5">
		[[!ms2Gallery?
			&resource=`32`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
			&tplEmpty=`0`
			&frontend_css=``
			&limit=`1`
		]]
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 5`:else=`СЕПТИК КРИСТАЛЛ 5`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
			...
			<div class="item">
				<div class="name">глубина трубы, см</div>
				<div class="value">70</div>
			</div>
			<div class="item">
				<div class="name">сброс воды</div>
				<div class="value"><span>самотек</span></div>
			</div>
		</div>
		<div class="price-block">
			<div class="price">76 000<span>руб</span></div>
			<div class="old_price">80 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-5/" title="СЕПТИК КРИСТАЛЛ 5" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="32">Купить</div></div>
			</div>
		</div>
	</div>
</div>
<div class="col-md-4">
	<div class="item-ware">
		<a href="septik-kristall-5-long/" title="СЕПТИК КРИСТАЛЛ 5 Long">
		[[!ms2Gallery?
			&resource=`33`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 5 long`:else=`СЕПТИК КРИСТАЛЛ 5 Long`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			<div class="price">85 500<span>руб</span></div>
			<div class="old_price">90 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-5-long/" title="СЕПТИК КРИСТАЛЛ 5 Long" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="33">Купить</div></div>
			</div>
		</div>
	</div>
</div>
<div class="col-md-4">
	<div class="item-ware">
		<a href="septik-kristall-8-long/" title="СЕПТИК КРИСТАЛЛ 8 Long">
		[[!ms2Gallery?
			&resource=`35`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8 long`:else=`СЕПТИК КРИСТАЛЛ 8 Long`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			<div class="price">108 300<span>руб</span></div>
			<div class="old_price">114 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-8-long/" title="СЕПТИК КРИСТАЛЛ 8 Long" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="35">Купить</div></div>
			</div>
		</div>
	</div>
</div>
	...
	<div id="kontakty">
	<section class="vpl-section vpl-section-17" style="background-image:url(uploads/bg_3_22.jpg);">
		<div class="container">
			<div class="row contact_data">
				[[!geoip? &metod=`region` &tpl=`contact_data`]]
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="media">
						<div class="media-left media-top">
							<div class="img"> <img src="uploads/icon/logo_white-236.svg"/> </div>
						</div>
						<div class="media-body">ООО "Кристалл-Септик" <br>
141035, Россия, ГП Мытищи, <br>
пос. Мебельной фабрики <br>
ул. Шоссейная стр. 1/1 <br></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="socnet">
		[[!getImageList? 
			...
			&docid=`1`
			&where=`{"active":"1"}`
			&tpl=`@CODE: <a href="[[+link]]" target="_blank"><img src="[[+image]]" alt="[[+caption]]"></a>`
		]]
	</div>
	<ul class="menu">
		<li class="type1"><a href="about/">О нас</a></li>
<li class="type2"><a href="catalog/">Каталог</a></li>
<li class="type3"><a href="septik-kristall-5/">СЕПТИК КРИСТАЛЛ 5</a></li>
<li class="type3"><a href="septik-kristall-5-long/">СЕПТИК КРИСТАЛЛ 5 Long</a></li>
<li class="type3"><a href="septik-kristall-8/">СЕПТИК КРИСТАЛЛ 8</a></li>
<li class="type3"><a href="septik-kristall-8-long/">СЕПТИК КРИСТАЛЛ 8 Long</a></li>
<li class="type1"><a href="otzyivyi/">Отзывы</a></li>
<li class="type1"><a href="video/">Видео</a></li>
<li class="type1"><a href="dilers/">Где купить</a></li>
	</ul>
	<div class="text"><a href="/">кристалл-септик.рф</a> – ОФИЦИАЛЬНЫЙ САЙТ ПРОИЗВОДИТЕЛЯ СЕПТИК КРИСТАЛЛ В РОССИИ </div>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
	Marquiz.init({ 
		id: \'[[!MobileDetect:is=`1`:then=`5c73f4fd83fe2500447dd917`:else=`5c328f838c1fd1004425caef`?input=`standard`]]\', 
		autoOpen: false, 
		autoOpenFreq: \'once\', 
		openOnExit: false 
	});
});
function ShowModalKQuizType1(){
  Marquiz.showModal(\'[[!MobileDetect:is=`1`:then=`5c73f4fd83fe2500447dd917`:else=`5c328f838c1fd1004425caef`?input=`standard`]]\');
}
</script>
<!-- Marquiz script end -->
<script type="text/javascript">var __cs = __cs || [];__cs.push(["setCsAccount", "dFCG_gvccsQqfQ05Qh1ko2tKEqM6rxMF"]);</script>
<script type="text/javascript" async src="https://app.uiscom.ru/static/cs.min.js"></script>
</div>
<div class="hide">
	<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 vpl-modal-green js-modal-callback"> <a href="" class="arcticmodal-close vpl-modal-close">x</a>
  ...
  'elementCache' => 
  array (
    '[[$script_in_head]]' => '<script type="text/javascript" >
   (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
   m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})
   (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym");
...
<script>
  ...
  gtag(\'config\', \'UA-134048217-1\');
    ...
    '[[pdoMenu?
					...
					&tplInner=`@INLINE <ul class="submenu [[+classnames]]">[[+wrapper]]</ul>`
					&tpl=`@INLINE <li class="vpl-menu-item item-[[+id]]"><a href="[[+link]]">[[+pagetitle]]</a>[[+wrapper]]</li>`
					&parents=`0`
					&level=`2`
					&includeTVs=`menu_main_show`
					&where=`{"menu_main_show":"1"}`
					]]' => '<li class="vpl-menu-item item-1"><a href="/">Главная</a><ul class="submenu "><li class="vpl-menu-item item-7"><a href="my-predlagaem/">Мы Предлагаем</a></li><li class="vpl-menu-item item-8"><a href="kak-rabotaem/">Как работаем</a></li><li class="vpl-menu-item item-9"><a href="galereja/">Галерея</a></li><li class="vpl-menu-item item-10"><a href="pochemu-vybirajut-nas/">Почему выбирают нас</a></li><li class="vpl-menu-item item-11"><a href="nam-doverjajut/">Нам доверяют</a></li></ul></li><li class="vpl-menu-item item-27"><a href="catalog/">Каталог</a></li><li class="vpl-menu-item item-43"><a href="rasschitat-pod-klyuch/">Рассчитать под ключ</a></li><li class="vpl-menu-item item-30"><a href="dilers/">Где купить</a></li><li class="vpl-menu-item item-44"><a href="informacziya/">Информация</a><ul class="submenu "><li class="vpl-menu-item item-26"><a href="about/">О нас</a></li><li class="vpl-menu-item item-45"><a href="news/">Новости</a></li><li class="vpl-menu-item item-29"><a href="video/">Видео</a></li><li class="vpl-menu-item item-28"><a href="otzyivyi/">Отзывы</a></li><li class="vpl-menu-item item-47"><a href="stock/">Акции</a></li></ul></li><li class="vpl-menu-item item-31"><a href="contacts/">Контакты</a></li>',
    '[[pdoMenu?
			&tplOuter=`@INLINE [[+wrapper]]`
			&tplInner=`@INLINE <ul class="submenu [[+classnames]]">[[+wrapper]]</ul>`
			...
			&parents=`0`
			&level=`2`
			&includeTVs=`menu_main_mobile_show,menu_main_mobile_sort`
			&where=`{"menu_main_mobile_show":"1"}`
			&sortby=`{"menu_main_mobile_sort":"ASC", "pagetitle":"DESC"}`
			]]' => '<li class="vpl-menu-item item-1"><a href="/">Главная</a></li><li class="vpl-menu-item item-27"><a href="catalog/">Каталог</a></li><li class="vpl-menu-item item-43"><a href="rasschitat-pod-klyuch/">Рассчитать под ключ</a></li><li class="vpl-menu-item item-30"><a href="dilers/">Где купить</a></li><li class="vpl-menu-item item-31"><a href="contacts/">Контакты</a></li><li class="vpl-menu-item item-44"><a href="informacziya/">Информация</a><ul class="submenu "><li class="vpl-menu-item item-26"><a href="about/">О нас</a></li><li class="vpl-menu-item item-45"><a href="news/">Новости</a></li><li class="vpl-menu-item item-29"><a href="video/">Видео</a></li><li class="vpl-menu-item item-28"><a href="otzyivyi/">Отзывы</a></li><li class="vpl-menu-item item-47"><a href="stock/">Акции</a></li></ul></li>',
    '[[$block_menu]]' => '<div class="regionselection">
	<div class="container">
		<div class="row">
			<div class="close">x</div>
			<ul>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[$breadcrumb]]' => '<div class="breadcrumb-wrapper container">
	[[!pdoCrumbs?
		&limit=`5`
		&showCurrent=`1`
		&showHome=`1`
    ...
    '[[getResourceField? &id=`11` &field=`content`]]' => '<h2 class="text-center">нам доверяют</h2>',
    '[[$block_doveryaut]]' => '<div id="nam-doverjajut">
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				<h2 class="text-center">нам доверяют</h2>
    ...
    '[[pdoResources? 
					&parents=`27` &outerClass=`0` &resources=`0` 
					&tpl=`similar_li` 
					&limit=`3`
					&includeTVs=`w_count_people,w_glubina_trubi,w_udal_vodi,w_price,w_old_price` 
					&sortby=`menuindex` &sortdir=`ASC` 
					&where=`{"template:=":12,"AND:id:!=":34}`]]' => '<div class="col-md-4">
	<div class="item-ware">
		<a href="septik-kristall-5/" title="СЕПТИК КРИСТАЛЛ 5">
		[[!ms2Gallery?
			&resource=`32`
...
ул. Шоссейная стр. 1/1 <br></div>
    ...
    '[[pdoResources?
			...
			&tpl=`footer-menu-li`
			&limit=`30`
			&includeTVs=`menu_footer_show,menu_footer_menuindex,menu_footer_type`
			&where=`{"menu_footer_show":"1"}`
			&sortby=`{"menu_footer_menuindex":"ASC", "pagetitle":"DESC"}`
		]]' => '<li class="type1"><a href="about/">О нас</a></li>
<li class="type2"><a href="catalog/">Каталог</a></li>
<li class="type3"><a href="septik-kristall-5/">СЕПТИК КРИСТАЛЛ 5</a></li>
<li class="type3"><a href="septik-kristall-5-long/">СЕПТИК КРИСТАЛЛ 5 Long</a></li>
...
<li class="type1"><a href="video/">Видео</a></li>
<li class="type1"><a href="dilers/">Где купить</a></li>',
    '[[$marquiz_script]]' => '<!-- Marquiz script start -->
<script src="//script.marquiz.ru/v1.js" type="application/javascript"></script>
<script>
document.addEventListener("DOMContentLoaded", function() {
	Marquiz.init({ 
...
<!-- Marquiz script end -->',
    '[[$script_footer]]' => '<!-- Marquiz script start -->
<script src="//script.marquiz.ru/v1.js" type="application/javascript"></script>
<script>
document.addEventListener("DOMContentLoaded", function() {
	Marquiz.init({ 
...
<script type="text/javascript">var __cs = __cs || [];__cs.push(["setCsAccount", "dFCG_gvccsQqfQ05Qh1ko2tKEqM6rxMF"]);</script>
<script type="text/javascript" async src="https://app.uiscom.ru/static/cs.min.js"></script>',
    '[[$footer]]' => '<div class="line-block-footer">
	<div class="socnet">
		[[!getImageList? 
			&tvname=`socnet_list`
			&limit=`5`
...
<script type="text/javascript" async src="https://app.uiscom.ru/static/cs.min.js"></script>',
    ...
    '[[pthumb? &input=`uploads/certificate/5/1.jpg` &options=`w=370&h=508&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/1.6bee21da881b2c90154234214a6f1848.jpg',
    '[[pthumb? &input=`uploads/certificate/5/2.jpg` &options=`w=370&h=508&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/2.6bee21da881b2c90154234214a6f1848.jpg',
    '[[pthumb? &input=`uploads/certificate/5/3.jpg` &options=`w=370&h=508&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/3.6bee21da881b2c90154234214a6f1848.jpg',
    '[[pthumb? &input=`uploads/Nechiporuk.jpeg` &options=`w=100&h=100&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/Nechiporuk.70b03cbe06f475a32d627a904ce2038f.jpg',
    '[[pthumb? &input=`uploads/orbant.jpg` &options=`w=100&h=100&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/orbant.70b03cbe06f475a32d627a904ce2038f.jpg',
    '[[pthumb? &input=`uploads/rassa.jpeg` &options=`w=100&h=100&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/rassa.70b03cbe06f475a32d627a904ce2038f.jpg',
    '[[pthumb? &input=`uploads/12.jpg` &options=`w=100&h=100&far=T&zc=1&q=90`]]' => '/assets/components/phpthumbof/cache/12.70b03cbe06f475a32d627a904ce2038f.jpg',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
...
<meta property="og:locality" content="Москва"/>
<meta property="og:country-name" content="Россия"/>
<meta property="og:image" content="[[++site_url]]tpl/images/logo.svg"/>
<meta property="og:url" content="[[*id:is=`1`:then=``:else=`[[++site_url]]`]][[~[[*id]]]]" />
<meta property="og:title" content="[[*seotitle]]" /> 
<meta property="og:description" content="[[*seodescription]]" />
[[*noindex:isequalto=`yes`:then=`<meta name="robots" content="noindex" />`]]
<!--[if lt IE 9]>
	<script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
	<script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
<![endif]-->
  ...
  gtag(\'config\', \'UA-134048217-1\');
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div class="regionselection">
	<div class="container">
		<div class="row">
			<div class="close">x</div>
			<ul>
...
<div class="line-top-logo">
	<div class="wrapper">
		<div class="logo">
			[[*id:is=`1`:then=`<img src="tpl/images/logo.svg" alt="Септик Кристалл — официальный сайт производителя"/>`:else=`<a href="/"><img src="tpl/images/logo.svg" alt="Септик Кристалл — официальный сайт производителя"/></a>`]]
		</div>
		[[*id:is=`1`:then=`<h1 class="slogan">[[#1.main-slogan]]</h1>`:else=`<div class="slogan">[[#1.main-slogan]]</div>`]]
	</div>
</div>
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			<div class="vpl-pull-menu" id="menu-pull"><i></i><i></i><i></i><i></i></div>
			<ul class="list-inline vpl-menu pc [[!If? &subject=`[[*id]]` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
				[[pdoMenu?
					&tplOuter=`@INLINE [[+wrapper]]`
					&tplInner=`@INLINE <ul class="submenu [[+classnames]]">[[+wrapper]]</ul>`
					&tpl=`@INLINE <li class="vpl-menu-item item-[[+id]]"><a href="[[+link]]">[[+pagetitle]]</a>[[+wrapper]]</li>`
...
<div id="menu" class="vpl-navbar">
	<ul class="list-inline vpl-menu mobile">
		[[pdoMenu?
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="regionselection">
	<div class="container">
		<div class="row">
			<div class="close">x</div>
			<ul>
...
<div id="menu" class="vpl-navbar">
	<ul class="list-inline vpl-menu mobile">
      ...
      array (
        ...
        array (
          ...
          'category' => 13,
          'cache_type' => 0,
          'snippet' => '<div class="breadcrumb-wrapper container">
	[[!pdoCrumbs?
		&limit=`5`
		&showCurrent=`1`
		&showHome=`1`
		...
		&outputSeparator=``
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="breadcrumb-wrapper container">
	[[!pdoCrumbs?
		&limit=`5`
		&showCurrent=`1`
		&showHome=`1`
      ...
      array (
        ...
        array (
          ...
          'source' => 2,
          'property_preprocess' => false,
          'name' => 'block_doveryaut',
          'description' => 'Блок работаем',
          'editor_type' => 0,
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div id="nam-doverjajut">
	<section class="vpl-section vpl-section-12">
		<div class="container">
			<div class="row">
				[[getResourceField? &id=`11` &field=`content`]]
				<div class="clearfix vpl-review-list">
					<div class="col-xs-5 col-xs-offset-1">
						[[!getImageList?
							&docid=`11`
	...
	<section class="vpl-section vpl-section-12">
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'block_tv',
          'description' => 'Блок с заголовком',
          'editor_type' => 0,
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div id="on-tv">
	<section class="vpl-section vpl-section-video">
	<div class="container">
		<div class="row">
			<h2 class="text-center">[[#36.tv_caption]]</h2>
			<div class="clearfix">
				<div class="responsive-embed widescreen">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/[[#36.tv_youtube]]"; frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</section>
	...
	<div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div id="kontakty">
	<section class="vpl-section vpl-section-17" style="background-image:url([[#2.cn_background]]);">
		<div class="container">
			<div class="row contact_data">
				[[!geoip? &metod=`region` &tpl=`contact_data`]]
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="media">
						<div class="media-left media-top">
							<div class="img"> <img src="[[#1.footer_logo]]"/> </div>
						</div>
						<div class="media-body">[[#1.footer_text_1]]</div>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="vpl-section vpl-section-17" style="background-image:url([[#2.cn_background]]);">
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div class="line-block-footer">
	<div class="socnet">
		[[!getImageList? 
			&tvname=`socnet_list`
			&limit=`5`
	...
	<div class="text">[[#01.footer_text_2]]</div>
</div>
[[$script_footer]]',
          'locked' => false,
          'properties' => 
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="line-block-footer">
	<div class="socnet">
		[[!getImageList? 
			&tvname=`socnet_list`
			&limit=`5`
...
[[$script_footer]]',
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'script_footer',
          'description' => 'Пользовательские скрипты в футере',
          'editor_type' => 0,
          'category' => 13,
          'cache_type' => 0,
          'snippet' => '[[$marquiz_script]]
<script type="text/javascript">var __cs = __cs || [];__cs.push(["setCsAccount", "dFCG_gvccsQqfQ05Qh1ko2tKEqM6rxMF"]);</script>
<script type="text/javascript" async src="https://app.uiscom.ru/static/cs.min.js"></script>',
          'locked' => false,
          'properties' => 
...
<script type="text/javascript" async src="https://app.uiscom.ru/static/cs.min.js"></script>',
      ...
      array (
        ...
        array (
          ...
          'category' => 13,
          'cache_type' => 0,
          'snippet' => '<!-- Marquiz script start -->
<script src="//script.marquiz.ru/v1.js" type="application/javascript"></script>
<script>
document.addEventListener("DOMContentLoaded", function() {
	Marquiz.init({ 
		id: \'[[!MobileDetect:is=`1`:then=`[[#01.QuizType1pc]]`:else=`[[#01.QuizType1mobile]]`?input=`standard`]]\', 
		autoOpen: false, 
		autoOpenFreq: \'once\', 
		openOnExit: false 
	});
...
function ShowModalKQuizType1(){
  Marquiz.showModal(\'[[!MobileDetect:is=`1`:then=`[[#01.QuizType1pc]]`:else=`[[#01.QuizType1mobile]]`?input=`standard`]]\');
}
</script>
<!-- Marquiz script end -->',
          'locked' => false,
	...
	<div class="content"></div>
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<div class="col-md-12 col-lg-7"> 
	<a href="mailto:[[#[[+id]].geo_email]]" class="footer_btn" >Почта: [[#[[+id]].geo_email]]</a>
	<div class="vpl-section-17-text-1">[[#[[+id]].geo_email_after]]</div>
	<div class="vpl-section-17-text-2">
		[[!getImageList? 
			&tvname=`geo_phones`
			&docid=`[[+id]]`
			&where=`{"active":"1"}`
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="col-md-12 col-lg-7"> 
	<a href="mailto:[[#[[+id]].geo_email]]" class="footer_btn" >Почта: [[#[[+id]].geo_email]]</a>
	<div class="vpl-section-17-text-1">[[#[[+id]].geo_email_after]]</div>
	<div class="vpl-section-17-text-2">
		[[!getImageList? 
	...
	if (!empty($toPlaceholder)) {
      ...
      array (
        ...
        array (
          ...
          'category' => 25,
          'cache_type' => 0,
          'snippet' => 'if(isset($id))$resource=$modx->getObject(\'modResource\', $id=$resource->get(\'id\'));
...
if($w_3d_model!=\'\'){
	...
	//echo \'<li class="model"><iframe name="model" id="model" allowfullscreen webkitallowfullscreen width="\'.$width.\'" height="\'.$height.\'" frameborder="0" seamless src="/loadmodel/?id=\'.$w_3d_model.\'"></iframe></li>\';
          ...
          'static' => false,
          'static_file' => '',
          'content' => 'if(isset($id))$resource=$modx->getObject(\'modResource\', $id=$resource->get(\'id\'));
	else $resource=$modx->resource;
$w_3d_model=$resource->getTVValue(\'w_3d_model\');
if($w_3d_model!=\'\'){
	if(!isset($width))$width=\'100%\';
...
return $output;',
          ...
          array (
            ...
            array (
              ...
              'area' => '',
              'desc_trans' => 'prop_pthumb.debug_desc',
              'area_trans' => '',
            ),
          ),
          'moduleguid' => '',
...
return (int)(strtolower($input) == $device);',
          ...
          array (
            ...
            array (
              ...
              'value' => 'mobile',
              'lexicon' => 'mobiledetect:properties',
              'area' => '',
              'desc_trans' => 'Тип устройста для проверки Standard, Tablet или Mobile',
              'area_trans' => '',
            ),
          ),
          'moduleguid' => '',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'type' => 'text',
          'name' => 'QuizType1mobile',
          'caption' => 'Копия Квиз 1 (Mobile)',
          'description' => '',
          'editor_type' => 0,
          'category' => 29,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'type' => 'textarea',
          'name' => 'geo_email_after',
          'caption' => 'Текст под Email',
          'description' => '',
          'editor_type' => 0,
          'category' => 13,
          'locked' => false,
