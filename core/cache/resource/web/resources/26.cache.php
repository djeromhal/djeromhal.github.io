<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h1>Завод <br /> производителя автономной канализации "Септик Кристалл" в России</h1>
<p> Компания Кристалл-Септик, официальный производитель систем очистки сточных вод Септик Кристалл. Основана в 2015 году в рамках производственного объединения НПО Альфа-Композит (производство изделий из стеклопластика). </p>
<p> Главной целью компании была разработка и выпуск универсального очистного оборудования для частного сектора на всей территории РФ. Именно поэтому Септик Кристалл сочетает в себе главные преимущества популярных очистных систем и остается экономически привлекательным для покупателя. </p>
<p> Производя стеклопластик из полиэфирных смол и стекловолокна, мы получаем корпус с высокой механической прочностью и коррозийной устойчивостью у которых нет конкуренции среди материалов, таких как полипропилен, полиэтилен, металл или бетон. Именно малый вес стеклопластика и разборная конструкция корпуса позволяют существенно сокращать логистические издержки, что прямо влияет на низкую стоимость септика. </p>
<p> Сама же конструкция и принцип работы отличаются простотой и максимальной надежностью. Это позволяет пользоваться септиком многие годы, без ощутимых трат на техническое обслуживания.  </p>
<p> Мы уверены в нашем оборудовании и поэтому предлагаем заключить договор с особыми гарантийными условиями. Мы вернем вам деньги, если в течении тестового периода 3 месяца вас не устроит качество работы нашего септика.</p>
<p> Наша компания открыты для сотрудничества. Что бы стать нашим партнером или клиентом, получив специальные условия, оставьте заявку, используя форму ниже.</p>',
    'richtext' => 1,
    'template' => 16,
    'menuindex' => 0,
    'searchable' => 1,
...
ООО "КРИСТАЛЛ-СЕПТИК"',
    ...
    array (
      0 => 'seotitle',
      1 => '«Септик Кристалл» официальный сайт завода производителя автономной канализации в Москве',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Официальный сайт завода производителя «Септик Кристалл» в России. Автономная канализация Кристалл от завада производителя. Узнать цены или купить можно на сайте по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл, завод, производитель, официальный сайт, автономная канализация',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>«Септик Кристалл» официальный сайт завода производителя автономной канализации в Москве</title>
<meta name="keywords" content="септик кристалл, завод, производитель, официальный сайт, автономная канализация"/>
<meta name="description" content="Официальный сайт завода производителя «Септик Кристалл» в России. Автономная канализация Кристалл от завада производителя. Узнать цены или купить можно на сайте по ☎ +7(495)104-42-44."/>
...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/about/" />
<meta property="og:title" content="«Септик Кристалл» официальный сайт завода производителя автономной канализации в Москве" /> 
<meta property="og:description" content="Официальный сайт завода производителя «Септик Кристалл» в России. Автономная канализация Кристалл от завада производителя. Узнать цены или купить можно на сайте по ☎ +7(495)104-42-44." />
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`26` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section text_section onas_page">
		<div class="container">
			<div class="text">
				<h1>Завод <br /> производителя автономной канализации "Септик Кристалл" в России</h1>
<p> Компания Кристалл-Септик, официальный производитель систем очистки сточных вод Септик Кристалл. Основана в 2015 году в рамках производственного объединения НПО Альфа-Композит (производство изделий из стеклопластика). </p>
<p> Главной целью компании была разработка и выпуск универсального очистного оборудования для частного сектора на всей территории РФ. Именно поэтому Септик Кристалл сочетает в себе главные преимущества популярных очистных систем и остается экономически привлекательным для покупателя. </p>
<p> Производя стеклопластик из полиэфирных смол и стекловолокна, мы получаем корпус с высокой механической прочностью и коррозийной устойчивостью у которых нет конкуренции среди материалов, таких как полипропилен, полиэтилен, металл или бетон. Именно малый вес стеклопластика и разборная конструкция корпуса позволяют существенно сокращать логистические издержки, что прямо влияет на низкую стоимость септика. </p>
<p> Сама же конструкция и принцип работы отличаются простотой и максимальной надежностью. Это позволяет пользоваться септиком многие годы, без ощутимых трат на техническое обслуживания.  </p>
...
<p> Наша компания открыты для сотрудничества. Что бы стать нашим партнером или клиентом, получив специальные условия, оставьте заявку, используя форму ниже.</p>
			...
			<div class="img">
				<img src="uploads/man-2.png" alt="Виталий Залыгин">
				<div class="info">
					<div class="name">Виталий Залыгин</div>
					<div class="dolgn">Генеральный директор<br>
ООО "КРИСТАЛЛ-СЕПТИК"</div>
				</div>
			</div>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[$block_clients]]' => '<section class="vpl-section vpl-section-14 " >
	<div class="container">
		<div class="row">
			<h2 class="text-center">НАШИ ПАРТНЕРЫ</h2>
			<div class="clearfix">
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'type' => 'text',
          'name' => 'our_production_list',
          'caption' => 'Список продукции (номера) через запятую',
          'description' => '',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
