<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<h2>Септик Кристалл – станция биологической очистки</h2>
<p>Септик Кристалл – недорогое и эффективное локальное очистное сооружение для обслуживания загородного дома и дачи, обеспечивающее очистку сточных до 98%. Устройство пользуется большим спросом, его можно недорого купить в Москве или заказать с доставкой в свой город.</p>
<h3>Конструкция <span class="bold">септика</span></h3>
<p>Конструктивно автономная канализация Кристалл имеет несколько особенностей. В конструкции исключены элементы способные засорится. Септик представляет собой единую камеру, поделенную на несколько зон. Камеры сообщаются между собой с помощью естественных переливов. Производитель станции позаботился об ускоренном осаждении с помощью диагональных стенок и камеры. Благодаря этому взвешенные частицы сгущаются и не проникают из рабочей зоны. Размеры автономной станции Кристалл не слишком велики.</p>
<h3>Как работает <span class="bold">автономная станция</span>?</h3>
<p>Станция Кристалл для дома или для дачи работает по принципу биологической очистки. Рассмотрим принцип действия септика более подробно:</p>
<ol type="1" start="1">
<li>Стоки попадают в центральную камеру, окисляются и перемешиваются с помощью воздуха в общем объеме воды.</li>
<li>В процессе рециркуляции в центральной камере, стоки постоянно проходят через блок погружной биозагрузки с закрепленными микроорганизмами.</li>
<li>При поступлении новых стоков, вода естественным образом сообщается с внешней камерой и отстаивается.</li>
<li>В конце жидкость подается в насосный резервуар. Оттуда она выводится наружу. Это происходит либо самотеком, либо принудительно.</li>
</ol>
<h3>Как пользоваться <span class="bold">септиком кристалл?</span></h3>
<p>Станция биологической очистки Кристалл весит около 80 кг, и установить ее можно самостоятельно, не применяя для этого строительную технику. Согласно инструкции, установка септика Кристалл состоит из следующих несложных этапов:</p>
<ol type="1" start="5">
<li>Проводятся земляные работы, котлован и траншеи подготавливаются для укладки трубопровода.</li>
<li>Дно котлована подготавливается с помощью песка или песчано-гравийной подушки.</li>
<li>Корпус очистного устанавливается, к нему подводятся трубы.</li>
<li>Выполняется обратная засыпка, параллельно с этим происходит заполнение водой.</li>
<li>Электрическое подключение, настройка и проверка работы всех узлов.</li>
</ol>
<p>При желании вы можете заказать септик под ключ и избавить себя от лишних хлопот. Покупка септика Кристалл с установкой дает гарантию и экономит время.</p>
<h3>Как и когда обслуживать кристалл?</h3>
<p>Незамысловатая комплектация септика кристалл упрощает обслуживание. Станция очистки Кристалл нуждается в откачке не чаще раза в год, при полной нагрузке. Все остальное время устройство функционирует без вмешательства. Чистка септика занимает не более 10 минут.</p>
<p>Для откачки допустимо использовать стандартный дренажный или фекальный насос. Для удобства, возможен вызов ассенизатора. Септики для дачи не требуют регулярной чистки, их откачивают по мере необходимости.</p>
<h3>Преимущества автономной станции кристалл</h3>
<p>Станция Кристалл отвечает главным требованиям владельцев участков, которые ищут надежное и экономичное оборудование. Локальное очистное сооружение Кристалл:</p>
<ul>
<li>имеет прочный цельный корпус без сварных швов, с повышенной прочностью;</li>
<li>обладает высоким объемом залпового сброса (от 300л) и большой производительностью (спуск целой ванны никак не отразится на рабочих показателях механизма);</li>
...
<h3>Приобретение и <span class="bold">стоимость септика кристалл</span></h3>
<p>Септик Кристалл, цена которого зависит от модели и технических характеристик, можно купить в Москве в нашем Интернет-магазине. У нас в продаже вы найдете оригинальные товары от производителя. К каждой станции прилагается паспорт.</p>
<p>Цена станции зависит от количества человек, которые будут ее эксплуатировать, суточной переработки, заглубленности подводящей трубы и необходимости в проведении монтажных мероприятий. У нас вы можете купить септик Кристалл под ключ или же приобрести станцию без последующей установки.</p>',
    'richtext' => 1,
    'template' => 15,
    'menuindex' => 1,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 9,
    'createdon' => 1546196910,
    'editedby' => 9,
    'editedon' => 1550441975,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1546196760,
    'publishedby' => 9,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'seotitle',
      1 => 'Септик Кристалл — купить станцию биологической очистки в Москве: Автономная канализация для дома и дачи',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Купить станцию биологической очистки Септик Кристалл в Москве. Автономная канализация для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл, купить кристалл септик, станция биологической очистки, автономная канализация кристалл',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Септик Кристалл — купить станцию биологической очистки в Москве: Автономная канализация для дома и дачи</title>
<meta name="keywords" content="септик кристалл, купить кристалл септик, станция биологической очистки, автономная канализация кристалл"/>
<meta name="description" content="Купить станцию биологической очистки Септик Кристалл в Москве. Автономная канализация для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44."/>
...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/catalog/" />
<meta property="og:title" content="Септик Кристалл — купить станцию биологической очистки в Москве: Автономная канализация для дома и дачи" /> 
<meta property="og:description" content="Купить станцию биологической очистки Септик Кристалл в Москве. Автономная канализация для дачи и дома. Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44." />
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`27` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section text_section catalog_list">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1>[[!*longtitle:isnot=``:theen=`Септик кристалл`:else=`Каталог`]]</h1>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3">
...
<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-8/" title="СЕПТИК КРИСТАЛЛ 8">
		[[!ms2Gallery?
			&resource=`34`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8`:else=`СЕПТИК КРИСТАЛЛ 8`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			...
			<div class="old_price">105 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-8/" title="СЕПТИК КРИСТАЛЛ 8" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="34">Купить</div></div>
			</div>
		</div>
	</div>
</div>
...
<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-5-pr/" title="СЕПТИК КРИСТАЛЛ 5 ПР">
		[[!ms2Gallery?
			&resource=`68`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 5 ПР`:else=`СЕПТИК КРИСТАЛЛ 5 ПР`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
			...
			<div class="item">
				<div class="name">сброс воды</div>
				<div class="value"><span>принудительно</span></div>
			</div>
		</div>
		<div class="price-block">
			<div class="price">83 600<span>руб</span></div>
			<div class="old_price">88 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-5-pr/" title="СЕПТИК КРИСТАЛЛ 5 ПР" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="68">Купить</div></div>
			</div>
		</div>
	</div>
</div>
<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-5-long-pr/" title="СЕПТИК КРИСТАЛЛ 5 Long ПР">
		[[!ms2Gallery?
			&resource=`69`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 5 long ПР`:else=`СЕПТИК КРИСТАЛЛ 5 Long ПР`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			<div class="price">93 100<span>руб</span></div>
			<div class="old_price">98 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-5-long-pr/" title="СЕПТИК КРИСТАЛЛ 5 Long ПР" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="69">Купить</div></div>
			</div>
		</div>
	</div>
</div>
<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-8-pr/" title="СЕПТИК КРИСТАЛЛ 8 ПР">
		[[!ms2Gallery?
			&resource=`70`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8 ПР`:else=`СЕПТИК КРИСТАЛЛ 8 ПР`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			<div class="price">107 350<span>руб</span></div>
			<div class="old_price">113 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-8-pr/" title="СЕПТИК КРИСТАЛЛ 8 ПР" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="70">Купить</div></div>
			</div>
		</div>
	</div>
</div>
<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-8-long-pr/" title="СЕПТИК КРИСТАЛЛ 8 Long ПР">
		[[!ms2Gallery?
			&resource=`71`
			&tplOuter=`@INLINE [[+rows]]`
			&tplRow=`@INLINE <img src="[[+350x350]]" title=\'[[+title]]\' alt=\'[[+alt]]\'/>`
		...
		<div class="name">[[!+longtitle:isnot=``:theen=`<span>СЕПТИК</span> КРИСТАЛЛ<span> –</span> 8 long ПР`:else=`СЕПТИК КРИСТАЛЛ 8 Long ПР`]]</div>
		</a>
		<div class="det">
			<div class="item">
				<div class="name">количество человек</div>
		...
		<div class="price-block">
			<div class="price">115 900<span>руб</span></div>
			<div class="old_price">122 000 руб</div>
		</div>
		<div class="button-block">
			<div class="row">
				<div class="col-md-6"><a href="septik-kristall-8-long-pr/" title="СЕПТИК КРИСТАЛЛ 8 Long ПР" class="button">Подробнее</a></div>
				<div class="col-md-6"><div class="button js-modal-open" data-modal="callback-bid" data-product="71">Купить</div></div>
			</div>
		</div>
	</div>
</div>
	...
	<section class="vpl-section text_section catalog_page">
		<div class="container content-text">
			<h2>Септик Кристалл – станция биологической очистки</h2>
<p>Септик Кристалл – недорогое и эффективное локальное очистное сооружение для обслуживания загородного дома и дачи, обеспечивающее очистку сточных до 98%. Устройство пользуется большим спросом, его можно недорого купить в Москве или заказать с доставкой в свой город.</p>
<h3>Конструкция <span class="bold">септика</span></h3>
<p>Конструктивно автономная канализация Кристалл имеет несколько особенностей. В конструкции исключены элементы способные засорится. Септик представляет собой единую камеру, поделенную на несколько зон. Камеры сообщаются между собой с помощью естественных переливов. Производитель станции позаботился об ускоренном осаждении с помощью диагональных стенок и камеры. Благодаря этому взвешенные частицы сгущаются и не проникают из рабочей зоны. Размеры автономной станции Кристалл не слишком велики.</p>
<h3>Как работает <span class="bold">автономная станция</span>?</h3>
...
<p>Цена станции зависит от количества человек, которые будут ее эксплуатировать, суточной переработки, заглубленности подводящей трубы и необходимости в проведении монтажных мероприятий. У нас вы можете купить септик Кристалл под ключ или же приобрести станцию без последующей установки.</p>
	...
	<div class="block_catalog_onstup_tv_contact"></div>
	<div id="kontakty">
...
<div id="menu" class="vpl-navbar">
    ...
    '[[pdoResources? 
					...
					&where=`{"template:=":12}`]]' => '<div class="col-lg-3">
	<div class="item-ware">
		<a href="septik-kristall-5/" title="СЕПТИК КРИСТАЛЛ 5">
		[[!ms2Gallery?
			&resource=`32`
