<?php  return array (
  ...
  array (
    ...
    'our_production_caption' => 
    array (
      0 => 'our_production_caption',
      1 => 'Наша продукция',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ...
    array (
      0 => 'seotitle',
      1 => 'Септик Кристалл — купить в Москве у официального дилера: адреса, цены, отзывы',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seodescription',
      1 => 'Септик Кристалл — купить у официального дилера в Москве с установкой. Адреса | Отзывы | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44.',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'seokeywords',
      1 => 'септик кристалл, купить, в москве, у официального дилера',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Септик Кристалл — купить в Москве у официального дилера: адреса, цены, отзывы</title>
<meta name="keywords" content="септик кристалл, купить, в москве, у официального дилера"/>
<meta name="description" content="Септик Кристалл — купить у официального дилера в Москве с установкой. Адреса | Отзывы | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44."/>
...
<meta property="og:url" content="https://xn----7sbqjdhfea6benejh.xn--p1ai/dilers/" />
<meta property="og:title" content="Септик Кристалл — купить в Москве у официального дилера: адреса, цены, отзывы" /> 
<meta property="og:description" content="Септик Кристалл — купить у официального дилера в Москве с установкой. Адреса | Отзывы | Узнать цены, технические характеристики, размеры, можно на сайте и по ☎ +7(495)104-42-44." />
...
<nav class="navbar vpl-navbar vpl-anim js-vpl-navbar">
	<div class="container-fluid text-center">
		<div class="row">
			...
			<ul class="list-inline vpl-menu pc [[!If? &subject=`30` &operator=`EQ` &operand=`1` &then=` scroll-event`]]">
...
<div id="menu" class="vpl-navbar">
	...
	<section class="vpl-section text_section dialer-page">
		<div class="wrapper">
			<h1>Официальные дилеры <br> <span><span class="bold">"Септик Кристалл"</span> в России</span></h1>
			<div class="sert-list">
				<div class="item">
					<div class="img"><img src="uploads/sertifikat.jpg" alt="сертифика"></div>
					<div class="data">
						<div class="name">Статус официального дилера подтверждается сертификатом </div>
						<div class="description">Спрашивайте сертификат официального дилера!</div>
					</div>
				</div>
			</div>
			<div class="dialer-list">
				<div class="item[[!If? &subject=`1` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Москва">
		Москва
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">aquor.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`49`
			&tvname=`dlr-phones`
			&tpl=`dealer-item-phone`
		]]
	</div>
</div>
<div class="sub-item">
	<div class="site">stroeco.com</div>
	<div class="phone">
		[[!getImageList?
			&docid=`48`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">septic-profi.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`52`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">emkosti-online.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`82`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`2` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Санкт-Петербург">
		Санкт-Петербург
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">народныйсептик.рф</div>
	<div class="phone">
		[[!getImageList?
			&docid=`54`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">septik-master.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`55`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">vozduhvoda.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`56`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">septic78.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`57`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">aquakomfort-spb.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`58`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">septik-pro.com/</div>
	<div class="phone">
		[[!getImageList?
			&docid=`86`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`3` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Петрозаводск">
		Петрозаводск
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">septik-ptz.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`60`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`4` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Калининград">
		Калининград
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">market-abs.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`62`
			&tvname=`dlr-phones`
...
<div class="sub-item">
	<div class="site">abscompany.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`63`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`5` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Тюмень">
		Тюмень
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">septik-tmn.ru</div>
	<div class="phone">
		[[!getImageList?
			&docid=`65`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`6` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Минск, РБ">
		Минск, РБ
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">kaskadenergo.by</div>
	<div class="phone">
		[[!getImageList?
			&docid=`67`
			&tvname=`dlr-phones`
...
<div class="item[[!If? &subject=`7` &operator=`eq` &operand=`1` &then=` first`]]">
	<div class="city">
		<img src="uploads/contact/placeholder.svg" alt="Пермь">
		Пермь
	</div>
	<div class="sub-list">
		<div class="sub-item">
	<div class="site">http://ecoservise.com</div>
	<div class="phone">
		[[!getImageList?
			&docid=`85`
			&tvname=`dlr-phones`
			...
			<div class="row two-but-cont-12">
				<div class="col-md-6"><button class="order js-modal-open" data-modal="callback-bid-plain">Заказать септик</button></div>
				<div class="col-md-6"><button class="bid js-modal-open" data-modal="callback-coop">Заявка на сотрудничество</button></div>
			</div>
		</div>
		<div class="big-map-form">
			<div class="info-block">
	<div class="caption">Свяжитесь с нами!</div>
	<form>
		<input type="hidden" name="type-data" value="send-form-type2">
		<div class="block first">
			<div class="fieldicon border-bottom">
				<img src="uploads/contact/inp_name.png" alt="">
				<input type="text" name="name" id="name" placeholder="Ваше имя">
			</div>
			<div class="fieldicon">
				<img src="uploads/contact/inp_phone.png" alt="">
				<input type="text" name="phone" id="phone" placeholder="Контактный телефон">
			</div>
		</div>
		<div class="block"><textarea name="message" id="massage" placeholder="Здравствуйте! Меня заинтересовали ваши услуги. Свяжитесь со мной по телефону."></textarea></div>
		<button type="submit">Позвоните мне</button>
		<div class="field check checkbox">
			<div class="check"></div>
			<input type="checkbox" id="i" name="did-not-work">
			Согласен на обработку 
			<a href="#">персональных данных</a>
		</div>
	</form>
</div>
			<div class="content"><iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3Ab7ae7523ff736feacb4ae9fdeccf55c30c3c31211dd66b394fc6338544aba4bd&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe></div>
		</div>
	</section>
...
<div id="menu" class="vpl-navbar">
    ...
    '[[pdoResources?
			...
			&sortby=`menuindex`
			&sortdir=`ASC`
			&includeTVs=`dlr-site-url,dlr-site-name`
			&where=`{"template":"23"}`
		]]' => '<div class="sub-item">
	<div class="site">aquor.ru</div>
	<div class="phone">
...
<div class="item[[!If? &subject=`7` &operator=`eq` &operand=`1` &then=` first`]]">
    ...
    '[[$map-info-block]]' => '<div class="info-block">
	<div class="caption">Свяжитесь с нами!</div>
	<form>
		<input type="hidden" name="type-data" value="send-form-type2">
		<div class="block first">
    ...
    '[[$map-dealer]]' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3Ab7ae7523ff736feacb4ae9fdeccf55c30c3c31211dd66b394fc6338544aba4bd&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
    '[[pdoResources?
	...
	<form>
      ...
      array (
        ...
        array (
          ...
          'category' => 15,
          'cache_type' => 0,
          'snippet' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3Ab7ae7523ff736feacb4ae9fdeccf55c30c3c31211dd66b394fc6338544aba4bd&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
          'locked' => false,
          'properties' => 
          array (
          ),
          'static' => false,
          'static_file' => '',
          'content' => '<iframe src="https://yandex.ua/map-widget/v1/?um=constructor%3Ab7ae7523ff736feacb4ae9fdeccf55c30c3c31211dd66b394fc6338544aba4bd&amp;source=constructor" width="100%" height="677" frameborder="0"></iframe>',
        ),
        'policies' => 
        array (
          'web' => 
